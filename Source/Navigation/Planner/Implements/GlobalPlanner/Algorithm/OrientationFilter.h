...
class OrientationFilter {
    public:
        ...
        virtual void processPath(const NS_DataType::PoseStamped& start,
                                 std::vector<NS_DataType::PoseStamped>& path);
                                 
        void pointToNext(std::vector<NS_DataType::PoseStamped>& path, int index);
        void interpolate(std::vector<NS_DataType::PoseStamped>& path,
