...
namespace NS_Planner
{
  ...
  public:
    ...
    TrajectoryPlanner (WorldModel& world_model,
                       ...
                       double min_vel_th = -1.0, double min_in_place_vel_th =
                           0.4,
    ...
    void
    setFootprint (std::vector<NS_DataType::Point> footprint)
    {
  ...
  private:
     ...
     */
    inline double
    computeNewXPosition (double xi, double vx, double vy, double theta,
                         double dt)
    {
     ...
     */
    inline double
    computeNewYPosition (double yi, double vx, double vy, double theta,
                         double dt)
    {
     ...
     */
    inline double
    computeNewThetaPosition (double thetai, double vth, double dt)
    {
     ...
     */
    inline double
    computeNewVelocity (double vg, double vi, double a_max, double dt)
    {
      if ((vg - vi) >= 0)
      {
    ...
    void
    getMaxSpeedToStopInTime (double time, double& vx, double& vy, double& vth)
    {
