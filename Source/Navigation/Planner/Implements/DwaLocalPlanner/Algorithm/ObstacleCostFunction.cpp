...
void ObstacleCostFunction::setFootprint(std::vector<NS_DataType::Point> footprint_spec) {
...
double ObstacleCostFunction::scoreTrajectory(Trajectory &traj) {
  ...
  if (footprint_spec_.size() == 0) {
    ...
    NS_NaviCommon::console.error("Footprint spec is empty, maybe missing call to setFootprint?");
    return -9;
  }
