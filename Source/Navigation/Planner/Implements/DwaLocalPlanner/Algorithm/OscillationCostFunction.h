...
public:
  ...
  void updateOscillationFlags(Eigen::Vector3f pos, NS_Planner::Trajectory* traj, double min_vel_trans);
...
private:
   ...
   */
  bool setOscillationFlags(NS_Planner::Trajectory* t, double min_vel_trans);
