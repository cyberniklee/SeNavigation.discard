...
namespace NS_Planner
{
  ...
  void
  LocalPlannerUtil::initialize (NS_NaviCommon::Service* service,
      ...
      NS_Transform::Stamped<NS_Transform::Pose>& goal_pose)
  {
    ...
    return NS_Planner::getGoalPose (service_, global_plan_, goal_pose);
  }
      ...
      std::vector<NS_DataType::PoseStamped>& transformed_plan)
  {
    ...
    if (!NS_Planner::transformGlobalPlan (service_, global_plan_, global_pose,
