...
namespace NS_Planner
{
  ...
  void
  OscillationCostFunction::setOscillationResetDist (double dist, double angle)
  {
  ...
  void
  OscillationCostFunction::updateOscillationFlags (Eigen::Vector3f pos,
  ...
  void
  OscillationCostFunction::resetOscillationFlagsIfPossible (
  ...
  void
  OscillationCostFunction::resetOscillationFlags ()
  {
  ...
  bool
  OscillationCostFunction::setOscillationFlags (NS_Planner::Trajectory* t,
                                                double min_vel_trans)
  {
    bool flag_set = false;
  ...
  double
  OscillationCostFunction::scoreTrajectory (Trajectory &traj)
  {
