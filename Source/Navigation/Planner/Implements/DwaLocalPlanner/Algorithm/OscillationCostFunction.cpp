...
void OscillationCostFunction::updateOscillationFlags(Eigen::Vector3f pos, NS_Planner::Trajectory* traj, double min_vel_trans) {
  if (traj->cost_ >= 0) {
...
bool OscillationCostFunction::setOscillationFlags(NS_Planner::Trajectory* t, double min_vel_trans) {
  bool flag_set = false;
