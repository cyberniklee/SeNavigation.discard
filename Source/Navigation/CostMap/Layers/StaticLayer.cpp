...
void StaticLayer::onInitialize()
{
  ...
  static_layer_loop = boost::thread(boost::bind(&StaticLayer::loopStaticMap, this));
...
void StaticLayer::processMap(const NS_DataType::OccupancyGrid& new_map)
{
  ...
  NS_NaviCommon::console.debug("Received a %d X %d map at %f m/pix", size_x, size_y, new_map.info.resolution);
      ...
      !layered_costmap_->isSizeLocked())
  {
    ...
    NS_NaviCommon::console.message("Resizing costmap to %d X %d at %f m/pix", size_x, size_y, new_map.info.resolution);
           ...
           origin_y_ != new_map.info.origin.position.y)
  {
    ...
    NS_NaviCommon::console.message("Resizing static layer to %d X %d at %f m/pix", size_x, size_y, new_map.info.resolution);
