...
bool intersects(std::vector<NS_DataType::Point>& polygon, float testx, float testy)
{
  bool c = false;
...
bool intersects_helper(std::vector<NS_DataType::Point>& polygon1, std::vector<NS_DataType::Point>& polygon2)
{
...
bool intersects(std::vector<NS_DataType::Point>& polygon1, std::vector<NS_DataType::Point>& polygon2)
{
