...
namespace NS_CostMap
{
  ...
  void
  CostmapLayer::touch (double x, double y, double* min_x, double* min_y,
  ...
  void
  CostmapLayer::addExtraBounds (double mx0, double my0, double mx1, double my1)
  {
  ...
  void
  CostmapLayer::useExtraBounds (double* min_x, double* min_y, double* max_x,
                                double* max_y)
  {
  ...
  void
  CostmapLayer::updateWithMax (Costmap2D& master_grid, int min_i, int min_j,
                               int max_i, int max_j)
  {
    if (!enabled_)
      return;
  ...
  void
  CostmapLayer::updateWithTrueOverwrite (Costmap2D& master_grid, int min_i,
  ...
  void
  CostmapLayer::updateWithOverwrite (Costmap2D& master_grid, int min_i,
                                     int min_j, int max_i, int max_j)
  {
    if (!enabled_)
      return;
  ...
  void
  CostmapLayer::updateWithAddition (Costmap2D& master_grid, int min_i,
                                    int min_j, int max_i, int max_j)
  {
    if (!enabled_)
      return;
