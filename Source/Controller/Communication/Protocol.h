...
#define SPI_RESULT_FAILURE 0x00
  ...
  enum
  {
    ...
    BASE_REG_PID_MAX_RIGHT = 0x28,
    BASE_REG_PID_MIN_RIGHT = 0x2C,

    BASE_REG_PID_KP_LEFT = 0x30,
    BASE_REG_PID_KI_LEFT = 0x38,
    BASE_REG_PID_KD_LEFT = 0x40,
    BASE_REG_PID_MAX_LEFT = 0x48,
    BASE_REG_PID_MIN_LEFT = 0x4C,

    BASE_REG_ACCEL_LIMIT = 0x50,
    BASE_REG_CNTL_DURATION = 0x58,

    BASE_REG_WHEEL_DIAMETER = 0x60,
    BASE_REG_WHEEL_TRACK = 0x68,
    BASE_REG_ENCODER_RESOLUTION = 0x70,
    BASE_REG_GEAR_REDUCTION = 0x78,

    BASE_REG_LINEAR_V = 0x80,
    BASE_REG_ANGULAR_V = 0x88,
    BASE_REG_V_SETTED = 0x90,

    BASE_REG_ODOM_X = 0xA0,
    BASE_REG_ODOM_Y = 0xA8,
    BASE_REG_ODOM_THETA = 0xB0,
