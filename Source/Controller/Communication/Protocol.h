...
#define SPI_RESULT_FAILURE 0x00
  ...
  enum
  {
    ...
    BASE_REG_TOLERANCE = 0x50,
    BASE_REG_CNTL_DURATION = 0x58,

    BASE_REG_TICKS_PER_METER = 0x60,
    BASE_REG_WHEEL_TRACK = 0x68,

    BASE_REG_TARGET_X = 0x70,
    BASE_REG_TARGET_Y = 0x78,
    BASE_REG_TARGET_THETA = 0x80,
    BASE_REG_TARGET_SETTED = 0x88,
    BASE_REG_TARGET_REACHED = 0x90,
