...
bool SpiComm::getRegister(unsigned short address, int length, unsigned char* bytes)
{
...
bool SpiComm::setRegister(unsigned short address, unsigned char* bytes, int length)
{
  CntlSpiRequestType request;
  CntlSpiResponseType response;
