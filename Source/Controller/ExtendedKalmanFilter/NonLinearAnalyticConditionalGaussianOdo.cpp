...
namespace NS_Controller
{
  ...
  ColumnVector
  NonLinearAnalyticConditionalGaussianOdo::ExpectedValueGet () const
  {
  ...
  Matrix
  NonLinearAnalyticConditionalGaussianOdo::dfGet (unsigned int i) const
  {
    ...
    else
    {
      ...
      {
        cerr << "This pdf Only has " << NumConditionalArgumentsGet ()
            << " conditional arguments\n";
        exit (-BFL_ERRMISUSE);
      }
      else
      {
        cerr << "The df is not implemented for the" << i
