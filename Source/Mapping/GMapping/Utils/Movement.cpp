...
namespace NS_GMapping
{
  ...
  OrientedPoint
  FSRMovement::move (const OrientedPoint& pt) const
  {
  ...
  void
  FSRMovement::compose (const FSRMovement& move2)
  {
    *this = composeMoves (*this, move2);
  }
  
  FSRMovement
  FSRMovement::composeMoves (const FSRMovement& move1, const FSRMovement& move2)
  {
    FSRMovement comp;
  ...
  OrientedPoint
  FSRMovement::movePoint (const OrientedPoint& pt, const FSRMovement& move1)
  {
  ...
  FSRMovement
  FSRMovement::moveBetweenPoints (const OrientedPoint& pt1,
  ...
  FSRMovement
  FSRMovement::invertMove (const FSRMovement& move1)
  {
    FSRMovement p_inv;
  ...
  OrientedPoint
  FSRMovement::frameTransformation (const OrientedPoint& reference_pt_frame1,
