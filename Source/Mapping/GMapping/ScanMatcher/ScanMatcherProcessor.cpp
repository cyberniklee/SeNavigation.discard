...
namespace NS_GMapping
{
  ...
  void
  ScanMatcherProcessor::setSensorMap (const SensorMap& smap,
  ...
  void
  ScanMatcherProcessor::processScan (const RangeReading & reading)
  {
  ...
  void
  ScanMatcherProcessor::setMatchingParameters (double urange, double range,
  ...
  void
  ScanMatcherProcessor::setRegistrationParameters (double regScore,
                                                   double critScore)
  {
    m_regScore = regScore;
  ...
  OrientedPoint
  ScanMatcherProcessor::getPose () const
  {
    return m_pose;
  }
