...
namespace NS_GMapping
{
  ...
  namespace NS_GFSReader
  {
    ...
    void
    Record::write (ostream& os)
    {
    }
    ;
    
    void
    CommentRecord::read (istream& is)
    {
    ...
    void
    CommentRecord::write (ostream& os)
    {
    ...
    void
    OdometryRecord::read (istream& is)
    {
      is >> dim;
    ...
    void
    RawOdometryRecord::read (istream& is)
    {
      is >> pose.x;
      is >> pose.y;
      is >> pose.theta;
    ...
    void
    EntropyRecord::write (ostream& os)
    {
    ...
    void
    ScanMatchRecord::read (istream& is)
    {
      is >> dim;
      for (unsigned int i = 0; i < dim; i++)
      {
    ...
    void
    ResampleRecord::read (istream& is)
    {
      is >> dim;
      for (unsigned int i = 0; i < dim; i++)
      {
...
//			cout << "c" << flush;
    ...
    double
    RecordList::getLogWeight (unsigned int i) const
    {
      double weight = 0;
      unsigned int currentIndex = i;
      for (RecordList::const_reverse_iterator it = rbegin (); it != rend ();
          it++)
      {
    ...
    double
    RecordList::getLogWeight (unsigned int i,
    ...
    void
    RecordList::printLastParticles (ostream& os) const
    {
      if (empty ())
        return;
      const ScanMatchRecord* scanmatch = 0;
    ...
    RecordList
    RecordList::computePath (unsigned int i,
                             RecordList::const_iterator frame) const
    {
      unsigned int currentIndex = i;
    ...
    void
    RecordList::printPath (ostream& os, unsigned int i, bool err,
                           bool rawodom) const
    {
      unsigned int currentIndex = i;
      OrientedPoint p (0, 0, 0);
