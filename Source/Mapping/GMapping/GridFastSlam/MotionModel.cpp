...
namespace NS_GMapping
{
  ...
  OrientedPoint
  MotionModel::drawFromMotion (const OrientedPoint& p, double linearMove,
  ...
  OrientedPoint
  MotionModel::drawFromMotion (const OrientedPoint& p,
  ...
  Covariance3
  MotionModel::gaussianApproximation (const OrientedPoint& pnew,
                                      const OrientedPoint& pold) const
  {
    OrientedPoint delta = absoluteDifference (pnew, pold);
