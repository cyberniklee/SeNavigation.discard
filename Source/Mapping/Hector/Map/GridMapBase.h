...
namespace NS_HectorMapping
{
  ...
  template<typename ConcreteCellType>
    ...
    public:
       ...
       */
      bool
      hasGridValue (int x, int y) const
      {
      ...
      bool
      pointOutOfMapBounds (const Eigen::Vector2f& pointMapCoords) const
      {
       ...
       */
      void
      allocateArray (const Eigen::Vector2i& newMapDims)
      {
      ...
      void
      setMapGridSize (const Eigen::Vector2i& newMapDims)
      {
      ...
      getWorldCoords (const Eigen::Vector2f& mapCoords) const
      {
       ...
       */
      inline Eigen::Vector2f
      getMapCoords (const Eigen::Vector2f& worldCoords) const
      {
      ...
      void
      setDimensionProperties (const Eigen::Vector2f& topLeftOffsetIn,
      ...
      void
      setDimensionProperties (const MapDimensionProperties& newMapDimProps)
      {
       ...
       */
      void
      setMapTransformation (const Eigen::Vector2f& topLeftOffset,
                            float cellLength)
      {
       ...
       */
      bool
      getMapExtends (int& xMax, int& yMax, int& xMin, int& yMin) const
      {
        int lowerStart = -1;
