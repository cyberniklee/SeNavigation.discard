...
namespace NS_HectorMapping
{
  ...
  template<typename ConcreteCellType, typename ConcreteGridFunctions>
    ...
    public:
      ...
      inline void
      updateLineBresenhami (const Eigen::Vector2i& beginMap,
      ...
      inline void
      bresenhamCellFree (unsigned int offset)
      {
      ...
      inline void
      bresenhamCellOcc (unsigned int offset)
      {
        ConcreteCellType& cell (this->getCell (offset));
      ...
      inline void
      bresenham2D (unsigned int abs_da, unsigned int abs_db, int error_b,
